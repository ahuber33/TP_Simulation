#include "Analyse_TP_first_study.hh"
...
void Analyse_TP()
{
  ...
  Analyse("test_proton.root", "test_He1+.root", "test_He2+.root", "TP", "PAUL test", 0.1, 0.6, 670e3, 50.8, 8.45, 40, 108.85, 120, 1, 0., false, 0, 0, 20, 1.4);
