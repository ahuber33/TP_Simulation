...
void Draw_Results(TH1F* Estart, TH2F* Pos_ALL, TH2F* EPos, TGraphErrors* gResolution, TGraphErrors* Nph)
{
  ...
  Pos_ALL->Draw("colz");
  Pos_ALL->SetTitle("");
  Pos_ALL->GetXaxis()->SetTitle("X Position [mm]");
  Pos_ALL->GetYaxis()->SetTitle("Y Position [mm]");
