...
void Analyse_TP()
{
  ...
  //Analyse("proton_E_1500_B_0.3_pinhole_0.15_Le1_320_Le2_25.root", "He1+_E_1500_B_0.3_pinhole_0.15_Le1_320_Le2_25.root", "He2+_E_1500_B_0.3_pinhole_0.15_Le1_320_Le2_25.root", "TP", "pinhole 150 um - B 0.3T - E 1500 kV/m - Le1 320 mm Le2 25 mm", 0.15, 0.3, 1.5e6, 50, 5, 320, 25, 100, 1, 0., false, -8, -5, -3.2, 1.4);
  //Analyse("proton_E_1500_B_0.3_pinhole_0.2_Le1_320_Le2_25.root", "He1+_E_1500_B_0.3_pinhole_0.2_Le1_320_Le2_25.root", "He2+_E_1500_B_0.3_pinhole_0.2_Le1_320_Le2_25.root", "TP", "pinhole 200 um - B 0.3T - E 1500 kV/m - Le1 320 mm Le2 25 mm", 0.2, 0.3, 1.5e6, 50, 5, 320, 25, 100, 1, 0., false, -8, -5, -3.2, 2);
  ...
  //Analyse("proton_Config4_ZnS_0.1.root", "He1+_Config4_ZnS_0.1.root", "He2+_Config4_ZnS_0.1.root", "Optical", "pinhole 100 um - B 0.3T - E 2000 kV/m - Le1 225 mm Le2 120 mm - ZnS 0.1 mm", 0.1, 0.3, 2e6, 50, 5, 225, 120, 100, 0, 0.1, true, -6, -4.5, -3.8, 1.);
  //Analyse("proton_Config4_ZnS_0.25.root", "He1+_Config4_ZnS_0.25.root", "He2+_Config4_ZnS_0.25.root", "Optical", "pinhole 100 um - B 0.3T - E 2000 kV/m - Le1 225 mm Le2 120 mm - ZnS 0.25 mm", 0.1, 0.3, 2e6, 50, 5, 225, 120, 100, 0, 0.25, true, -6, -4.5, -3.8, 1.);  
  //Analyse("proton_Config4_ZnS_0.5.root", "He1+_Config4_ZnS_0.5.root", "He2+_Config4_ZnS_0.5.root", "Optical", "pinhole 100 um - B 0.3T - E 2000 kV/m - Le1 225 mm Le2 120 mm - ZnS 0.5 mm", 0.1, 0.3, 2e6, 50, 5, 225, 120, 100, 0, 0.5, true, -6, -4.5, -3.8, 1.2);
  Analyse("proton_Config4_ZnS_1.root", "He1+_Config4_ZnS_1.root", "He2+_Config4_ZnS_1.root", "Optical", "pinhole 100 um - B 0.3T - E 2000 kV/m - Le1 225 mm Le2 120 mm - ZnS 1 mm", 0.1, 0.3, 2e6, 50, 5, 225, 120, 100, 0, 1, true, -5, -3.8, -3.7, 1.2);
  ...
  //Analyse("proton_Config3_ZnS_0.1.root", "He1+_Config3_ZnS_0.1.root", "He2+_Config3_ZnS_0.1.root", "Optical", "pinhole 100 um - B 0.3T - E 2000 kV/m - Le1 225 mm Le2 120 mm - ZnS 0.1 mm ", 0.1, 0.3, 2e6, 50, 5, 225, 120, 100, 0., 0.1, true, -3.5, -5, -3.2, 0.9);
  ...
  //Analyse("proton_Config3_ZnS_0.5.root", "He1+_Config3_ZnS_0.5.root", "He2+_Config3_ZnS_0.5.root", "Optical", "pinhole 100 um - B 0.3T - E 2000 kV/m - Le1 225 mm Le2 120 mm - ZnS 0.5 mm ", 0.1, 0.3, 2e6, 50, 5, 225, 120, 100, 0., 0.5, true, -4., -5, -3.2, 0.7);
  //Analyse("proton_Config3_ZnS_1.root", "He1+_Config3_ZnS_1.root", "He2+_Config3_ZnS_1.root", "Optical", "pinhole 100 um - B 0.3T - E 2000 kV/m - Le1 225 mm Le2 120 mm - ZnS 1 mm ", 0.1, 0.3, 2e6, 50, 5, 225, 120, 100, 0., 1, true, -4., -5, -3.2, 1.3);
  ...
  //Analyse("proton_Config1_ZnS_0.25.root", "He1+_Config1_ZnS_0.25.root", "He2+_Config1_ZnS_0.25.root", "Optical", "pinhole 100 um - B 0.3T - E 2000 kV/m - Le1 225 mm Le2 120 mm - ZnS 0.25 mm ", 0.1, 0.3, 2e6, 50, 5, 225, 120, 100, 0., 0.25, true, -5, -5, -3.2, 0.9);
  //Analyse("proton_Config1_ZnS_0.5.root", "He1+_Config1_ZnS_0.5.root", "He2+_Config1_ZnS_0.5.root", "Optical", "pinhole 100 um - B 0.3T - E 2000 kV/m - Le1 225 mm Le2 120 mm - ZnS 0.5 mm ", 0.1, 0.3, 2e6, 50, 5, 225, 120, 100, 0., 0.5, true, -5, -5, -3.2, 1.3);
  //Analyse("proton_Config1_ZnS_1.root", "He1+_Config1_ZnS_1.root", "He2+_Config1_ZnS_1.root", "Optical", "pinhole 100 um - B 0.3T - E 2000 kV/m - Le1 225 mm Le2 120 mm - ZnS 1 mm ", 0.1, 0.3, 2e6, 50, 5, 225, 120, 100, 0., 1, true, -5, -5, -3.2, 1.3);
  ...
  //Analyse("proton_Config2_ZnS_0.1.root", "He1+_Config2_ZnS_0.1.root", "He2+_Config2_ZnS_0.1.root", "Optical", "pinhole 100 um - B 0.3T - E 2000 kV/m - Le1 225 mm Le2 120 mm - ZnS 0.1 mm ", 0.1, 0.3, 2e6, 50, 5, 225, 120, 100, 0., 0.1, true, -7, -5, -3.2, 1.7);
  //Analyse("proton_Config2_ZnS_0.25.root", "He1+_Config2_ZnS_0.25.root", "He2+_Config2_ZnS_0.25.root", "Optical", "pinhole 100 um - B 0.3T - E 2000 kV/m - Le1 225 mm Le2 120 mm - ZnS 0.25 mm ", 0.1, 0.3, 2e6, 50, 5, 225, 120, 100, 0., 0.25, true, -7, -5, -3.8, 1.6);
  //Analyse("proton_Config2_ZnS_0.5.root", "He1+_Config2_ZnS_0.5.root", "He2+_Config2_ZnS_0.5.root", "Optical", "pinhole 100 um - B 0.3T - E 2000 kV/m - Le1 225 mm Le2 120 mm - ZnS 0.5 mm ", 0.1, 0.3, 2e6, 50, 5, 225, 120, 100, 0., 0.5, true, -5, -5, -3.2, 1.3);
  //Analyse("proton_Config2_ZnS_1.root", "He1+_Config2_ZnS_1.root", "He2+_Config2_ZnS_1.root", "Optical", "pinhole 100 um - B 0.3T - E 2000 kV/m - Le1 225 mm Le2 120 mm - ZnS 1 mm ", 0.1, 0.3, 2e6, 50, 5, 225, 120, 100, 0., 1, true, -5, -5, -3.2, 1.3);
